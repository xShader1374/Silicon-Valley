...
func _on_damage_area_body_entered(body: Node3D) -> void:
	if body.is_in_group("weapons"):
		...
		if is_defending:
			if parry:
				SfxPlayer.play_3D(5, 0.9, 1.1, enemy_weapon.global_position, null, 0.0, 80.0, 80.0)
				...
				SfxPlayer.play_3D(4, 0.9, 1.1, enemy_weapon.global_position, null, 0.0, 80.0, 80.0)
